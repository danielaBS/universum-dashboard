...
import styles from './tableInterpretation.module.scss';
...
import Paginate from '../tableSection/paginate/paginate';

const TableInterpretation = ({
  list,
  colNames,
  title,
  subtitle,
...
export default TableInterpretation;
